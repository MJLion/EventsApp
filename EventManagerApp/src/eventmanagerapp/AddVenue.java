...
public class AddVenue extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Add a Venue");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("Add A New Venue By Entering The Details Below:");

        jLabel2.setText("Name of the venue:");

        jLabel3.setText("Street address number:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //Check if the user has entered the required data before saving
